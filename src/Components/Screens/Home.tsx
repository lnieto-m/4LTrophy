...
export const Home = () => {
  return (
    <div className="w-full">
      ...
      <VerticalTimeline lineColor="#FF4444">
      ...
      <div className="flex max-w-[1024px] m-auto md:flex-row flex-col px-2 py-7">
        <section className="flex flex-col flex-1 justify-center p-3">
